		...
		var n = {
			...
			applyReductionCode: function() {
				var r = document.forms.checkoutForm,
					n = ["_method", "reductionCode", "email", "differenceAddress", "billingPhone"],
					t, i;
			...
			getTextShippingPriceFinal: function() {
				...
				for (var n = 0; n < this.shippingMethods.length; n++)
					if (this.shippingMethods[n].name === this.shippingMethod) return this.shippingMethods[n].textPriceFinal;
				return "-"
			},
			getTextShippingPriceOriginal: function() {
				if (!this.shippingMethods) return "-";
				for (var n = 0; n < this.shippingMethods.length; n++)
					if (this.shippingMethods[n].name === this.shippingMethod) return this.shippingMethods[n].textPriceOriginal;
				return ""
			},
		...
		var t = {
			handlePayment: function(i, r) {
				var u = JSON.parse(i),
					...
					f = null,
					o;
				u && u.payment_data && u.payment_data.user_no && (f = "authentication_token_".concat(u.payment_data.user_no), o = localStorage.getItem(f), e = t.decodeString(o, u.public_key));
				AfteeVn.config({
					pre_token: e,
			...
			encodeString: function(n, t) {
				var r, i, u;
				if (!n || !t) return n;
				for (r = "", i = 0; i < n.length; i++) u = String.fromCharCode(n.charCodeAt(i) ^ t.charCodeAt(i % t.length)), r += u;
				return r
			},
