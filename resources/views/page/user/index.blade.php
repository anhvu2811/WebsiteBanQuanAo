...
<div>
    <section class="awe-section-1" data-aos="fade" data-aos-duration="1000">
    ...
    <section class="awe-section-3" data-aos="fade" data-aos-duration="1000">
                           ...
                           <div class="swiper-slide">
                              <div class="product-box a-center">
                                 <div class="product-thumbnail"> 
                                    ...
                                    @endif
                                    <a href="/collections/{{ $hotTrendProduct->product->slug }}-{{ $hotTrendProduct->product->id }}" title="{{ $hotTrendProduct->product->name }}">
                                       <picture>
    ...
    <section class="awe-section-4" data-aos="fade" data-aos-duration="1000">
    ...
    <section class="awe-section-5" data-aos="fade" data-aos-duration="1000">
                                    ...
                                    <div class="swiper-slide">
                                       <div class="product-box a-center">
                                          <div class="product-thumbnail">
                                             ...
                                             <a href="/collections/{{ $product->slug }}-{{ $product->id }}" title="{{ $product->name }}">
                                                <picture>
                                                   ...
                                                   <img width="240" height="240" data-src="{{ $imageUrl }}" alt="{{ $product->name }}" class="lazyload img-responsive center-block zoom-hover">
                                                </picture>
                                             </a>
                                             {{-- <div class="product-action clearfix">
                                                <form action="{{ route('cart.add') }}" method="post" class="variants form-nut-grid" data-id="product-actions-507866" enctype="multipart/form-data">
    ...
    <section class="awe-section-6" data-aos="fade" data-aos-duration="1000">
        <div class="section section-collection-products products-view-grid">
           <div class="container">
              <div class="row">
