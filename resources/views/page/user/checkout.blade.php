   ...
   @if(auth()->check() && $cartCount > 0)
      <body data-no-turbolink="">
         ...
         <div data-tg-refresh="checkout" id="checkout" class="content">
            <form id="checkoutForm" method="post" action="{{ route('order.create') }}" enctype="multipart/form-data">
               @csrf
               <div class="wrap">
                  <main class="main">
                        ...
                        <article class="animate-floating-labels row">
                           ...
                           <div class="col col--two">
                              ...
                              <section class="section">
                                       ...
                                       <div class="content-box__row">
                                          <div class="radio-wrapper">
                                             <div class="radio__input">
                                                <input name="paymentMethod" id="shipCode" type="radio" class="input-radio" data-bind="paymentMethod" value="COD" data-provider-id="4">
                                             </div>
                                 ...
                                 <div class="section__content" style="margin-top: 10px;">
                                    <div class="content-box" data-define="{paymentMethod: undefined}">
                                       <div class="content-box__row">
                                          <div class="radio-wrapper">
                                             <div class="radio__input">
                                                <input name="paymentMethod" id="creditCard" type="radio" class="input-radio" data-bind="paymentMethod" value="Credit Card" data-provider-id="4">
                                             </div>
                                             <label for="paymentMethod-24237" class="radio__label">
                                  ...
                                  <div class="section__content" style="margin-top: 10px;">
                                    <div class="content-box" data-define="{paymentMethod: undefined}">
                                       <div class="content-box__row">
                                          <div class="radio-wrapper">
                                             <div class="radio__input">
                                                <input name="paymentMethod" id="qrcode" type="radio" class="input-radio" data-bind="paymentMethod" value="QR Code" data-provider-id="4">
                                             </div>
                                             <label for="paymentMethod-24237" class="radio__label">
                                             <span class="radio__label__primary">Thanh toán bằng QR Code</span>
                                             <span class="radio__label__accessory">
                                             <span class="radio__label__icon">
                                             <i class="payment-icon payment-icon--4"></i>
                                             </span>
                                 ...
                                 <div style="text-align: center; margin-top: 40px;" class="qrcode hide">
                                    @php
                                       $stk = "1820128112002";
                                       $bank = "mbbank"; 
                                       $amount = $total;
                                       $addInfo = "THANHTOAN-ORDER-#";
                                    @endphp
                                    <img src="https://img.vietqr.io/image/{{$bank}}-{{$stk}}-compact2.png?amount={{$amount}}&addInfo={{$addInfo}}" width="350px"/>
                                 </div>
                              </section>
                           </div>
                        </article>
                        <div class="field__input-btn-wrapper field__input-btn-wrapper--vertical hide-on-desktop">
                           <button type="submit" class="btn btn-checkout btn-order spinner" data-bind-class="{'spinner--active': isSubmitingCheckout}" data-bind-disabled="isSubmitingCheckout || isLoadingReductionCode">
                              <span class="spinner-label">ĐẶT HÀNG</span>
                              <svg xmlns="http://www.w3.org/2000/svg" class="spinner-loader">
                                 <use href="#spinner"></use>
                              </svg>
                           </button>
                           <button class="btn btn-checkout btn-continue-payment spinner hide" data-bind-class="{'spinner--active': isSubmitingCheckout}" data-bind-disabled="isSubmitingCheckout || isLoadingReductionCode" id="btn-continue-payment">
                        ...
                        <div id="order-summary" class="order-summary order-summary--is-collapsed">
                           <div class="order-summary__sections">
                              ...
                              <div class="order-summary__nav field__input-btn-wrapper hide-on-mobile layout-flex--row-reverse">
                                 <button type="submit" class="btn btn-checkout btn-order spinner">
                                    <span class="spinner-label">ĐẶT HÀNG</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="spinner-loader">
                                       <use href="#spinner"></use>
                                    </svg>
                                 </button>
                                 <button class="btn btn-checkout btn-continue-payment spinner hide" id="btn-continue-payment">
                                    <span class="spinner-label">TIẾP TỤC THANH TOÁN</span>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="spinner-loader">
                                       <use href="#spinner"></use>
                                    </svg>
...
<script>
   $(document).ready(function() {
      $('#qrcode').click(function() {
         ...
         $('.btn-continue-payment').addClass('hide');
      ...
      $('#creditCard').click(function() {
         $('.qrcode').addClass('hide');
         $('.btn-continue-payment').removeClass('hide');
